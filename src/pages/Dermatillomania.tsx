...
const Dermatillomania = () => {
  ...
  const { likes, isLiked, comments, handleLike, handleSubmitComment, handleDeleteComment, canDeleteComment, displayName, setUserDisplayName } = useArticleData('dermatillomania');
